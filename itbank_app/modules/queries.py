...
con = sqlite3.connect(r'C:\Users\Benja\Desktop\ITBA\django_app\mytestsite\itbank.db', check_same_thread=False) # -> el segundo argumento es para poder leer la base desde main.py
